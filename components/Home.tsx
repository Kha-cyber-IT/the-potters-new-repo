...
// --- CUSTOM SCROLL-TRIGGERED COUNTER COMPONENTS ---

// Counter: Starts at 1000, speeds up to 4000
const ChurchCounter = ({ start }: { start: boolean }) => {
  const [count, setCount] = useState(1000);

  useEffect(() => {
    if (!start) return; // Wait until visible to start counting
...
const CountryCounter = ({ start }: { start: boolean }) => {
...
export const Home: React.FC<NavigationProps> = ({ setPage }) => {
  ...
  return (
    <div className="animate-fade-in bg-white min-h-screen w-full pb-0 overflow-x-hidden text-gray-900">
          ...
          <div className="flex flex-col gap-6 md:gap-8 w-full z-10">
            ...
            >
              <span className="block overflow-hidden pb-2">
                <motion.span variants={lineReveal} className="block origin-bottom-left">
      ...
      {/* OVERLAPPING STATS & NEW BUILDING SECTION */}
      <div className="w-full px-4 md:px-6 relative z-20 -mt-10 md:-mt-20 mb-12">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-stretch">
          ...
          <motion.div 
            ...
            className="bg-[#121519] border border-gray-800 rounded-2xl md:rounded-[3rem] p-6 md:p-12 relative overflow-hidden shadow-2xl flex items-center justify-center min-h-[250px]"
          >
            <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-8 md:gap-16 text-center w-full">
              {/* 4000+ Churches */}
              <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 300 }}>
                <h3 className="text-4xl sm:text-5xl md:text-6xl font-black text-white tracking-tighter">
                  <ChurchCounter start={statsInView} />+
                </h3>
              ...
              <div className="w-16 h-[1px] bg-white/20 block sm:hidden" />
              
              {/* 195 Countries */}
              <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 300 }}>
                <h3 className="text-4xl sm:text-5xl md:text-6xl font-black text-white tracking-tighter">
                  <CountryCounter start={statsInView} />
                </h3>
          ...
          <motion.div 
            ...
            className="block relative rounded-2xl md:rounded-[3rem] overflow-hidden border border-gray-200 cursor-pointer h-[250px] md:h-auto shadow-2xl group w-full"
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-end p-6 md:p-8 text-center z-10">
              <h3 className="text-3xl md:text-4xl font-black text-white uppercase tracking-tighter drop-shadow-md">We're Enlarging!</h3>
            </div>
          </motion.div>
      ...
      <div className="w-full text-center px-4 md:px-6 mt-12 md:mt-24">
        ...
        <div className="mb-12 md:mb-24">
          <motion.h3 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-gray-900 text-xl md:text-4xl font-black mb-8 md:mb-12 uppercase tracking-widest underline underline-offset-8"
          >
            Weekly Services
          </motion.h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 max-w-[1400px] mx-auto">
            <motion.div 
              initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.5 }}
              className="bg-[#FEFACD] rounded-2xl p-6 text-left shadow-sm hover:shadow-md transition-shadow"
            >
            ...
            <motion.div 
              ...
              className="bg-[#F26749] rounded-2xl p-6 text-left text-white shadow-sm hover:shadow-md transition-shadow"
            >
            ...
            <motion.div 
              ...
              className="bg-[#F5E6A3] rounded-2xl p-6 text-left text-gray-900 shadow-sm hover:shadow-md transition-shadow"
            >
        ...
        <div className="w-full py-8 md:py-16 px-0">
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-stretch">
            ...
            <motion.div 
              ...
              className="bg-[#ACC8A2] p-6 md:p-12 rounded-2xl md:rounded-[3rem] flex flex-col items-center justify-center"
            >
            ...
            <motion.div 
              ...
              className="bg-[#ffd3c0] p-6 md:p-12 rounded-2xl md:rounded-[3rem] flex flex-col items-center justify-center"
            >
              ...
              <div className="w-[100px] h-[100px] md:w-[120px] md:h-[120px] mb-6 flex justify-center items-center mix-blend-multiply">
                <img 
                  src="https://i.postimg.cc/fk4SF43X/cd47db21186f31f0c1a16b65802200d7.jpg" 
        ...
        <div className="w-full py-8 md:py-16 mb-12">
          <motion.div 
            ...
            className="max-w-[1400px] mx-auto px-0"
          >
